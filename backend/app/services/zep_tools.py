...
Requirements:
1. Each sub-query should be specific enough to find relevant Agent behaviors or events in the simulated world.
...
Return a list of sub-queries in JSON format."""
    ...
    def interview_agents(
        ...
        INTERVIEW_PROMPT_PREFIX = (
            ...
            "4. Answer each question one by one by its number, each answer starting with 'Question X:' (X is the question number).\n"
            "5. Separate answers between each question with an empty line.\n"
            "6. Answers should have substantive content, at least 2-3 sentences for each question.\n\n"
        )
    ...
    def _select_agents_for_interview(
        ...
        system_prompt = """You are a professional interview planning expert. Your task is to select the most suitable candidates for an interview from a list of simulated Agents based on interview requirements.

Selection Criteria:
1. The identity/profession of the Agent is relevant to the interview topic.
...
Please select up to {max_agents} Agents most suitable for the interview and explain the reasons for selection."""
    ...
    def _generate_interview_questions(
        ...
        system_prompt = """You are a professional journalist/interviewer. Generate 3-5 deep interview questions based on interview requirements.

Question Requirements:
1. Open-ended questions, encouraging detailed answers.
2. Different answers possible for different roles.
3. Cover multiple dimensions such as facts, viewpoints, feelings, etc.
4. Natural language, like a real interview.
5. Each question controlled within 50 characters, concise and clear.
...
Please generate 3-5 interview questions."""
        ...
        try:
            ...
            return [
                f"What are your thoughts on {interview_requirement}?",
                "How does this affect you or the group you represent?",
                "What do you think should be done to solve or improve this issue?"
            ]
...
1. Refine the main viewpoints of all parties.
